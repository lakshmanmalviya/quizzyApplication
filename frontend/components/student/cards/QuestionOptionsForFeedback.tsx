...
const QuestionOptionsForFeedback: React.FC<QuestionOptionsForFeedbackProps> = ({ index, attemptedQuestion, presentQuestion }) => {
    ...
    return (
        <div className={styles.questionContainer}>
            {
                attemptedQuestion.text &&
                <label htmlFor={`question` + attemptedQuestion.id}
            ...
            {
                checkIsBase64Boolean(attemptedQuestion.questionPic) &&
                <label htmlFor={`question` + attemptedQuestion.id}>
                    <div className={styles.optionImage}>
                        <img
                            src={attemptedQuestion.questionPic}
                            style={{ width: '100%', height: '250px', margin: '0px', objectFit: 'contain' }}
                        />
                    </div>
                </label>
            }
