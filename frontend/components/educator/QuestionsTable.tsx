...
const QuestionsTable: React.FC = () => {
    ...
    return (
        <div>
                ...
                <Box className={styles.tableBox}>
                    <TableContainer component={Paper} className={styles.tableContainer}>
                        <Table stickyHeader sx={{ minWidth: 650 }}>
                            <TableHead>
                                <TableRow className={questionLoading ? `${styles.onReset} ${styles.rowStyle}` : ''}>
                                    ...
                                    <TableCell align="left" className={styles.rowStyle}>Quiz</TableCell>
                                        ...
                                        <TableRow key={question.id}>
                                            <Tooltip title={question.text} placement="top"
                                                ...
                                                <TableCell component="th" scope="row" align="left">
                                                    {Boolean(question.text.length <= 17) ? question.text : (question.text.substring(0, 17) + "...")}
                                                </TableCell>
                                            </Tooltip>
                                            ...
                                            <Tooltip title={question.quiz?.title} placement="top" enterDelay={300}
                                                ...
                                                <TableCell align="left">
                                                    {(question.quiz?.title ?? '').length <= 50
                                                        ? question.quiz?.title
                                                        : question.quiz?.title.substring(0, 50) + '...'}
                                                </TableCell>
                                            </Tooltip>
            ...
            {openQuestionModal && <QuestionCreateModal onClose={handleCloseQuestionModal} />}
            {open && <QuestionEditModal question={editQuestion} onClose={handleClose} index={clickedIndex + 1} />
            }
            {openConfirmBox &&
