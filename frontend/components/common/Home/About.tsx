      ...
      <div>
        ...
        <Box sx={{ marginBottom: '40px' }}>
          ...
          <div className={styles.gridContainer}>
            <div className={styles.gridItem}><Grid item xs={12} sm={6} md={3} className={styles.cardWithFixSize}>
            ...
            <div className={styles.gridItem}>
              <Grid item xs={12} sm={6} md={3} className={styles.cardWithFixSize}>
        ...
        <Box sx={{ marginBottom: '40px' }}>
          ...
          <Grid container spacing={3} sx={{ display: 'flex', flexWrap: 'wrap', marginTop: '50px' }}>
            ...
            <Grid item xs={12} sm={6} md={6} lg={6} className={styles.card}
              ...
              <Typography variant="body2" fontSize={16}>
                Co-Founder & Associate Developer
            ...
            <Grid item xs={12} sm={6} md={6} lg={6} className={styles.card}
              ...
              <Typography variant="h6"><b>Ishaan Gangrade</b></Typography>
              <Typography variant="body2" fontSize={16}>
