...
import { fetchAdminProfileDataRequest, fetchEducatorProfileDataRequest, fetchUserRequest } from '@/redux/slices/usersSlice';
...
const AdminProfile: React.FC = () => {
    const { user, adminProfileData, userLoading } = useAppSelector((state: RootState) => state.user);
                            ...
                            <Grid container spacing={4} alignItems="center" justifyContent='center'>
                                ...
                                >
                                    ...
                                    <Tooltip title={user.email} placement="top"
                                        ...
                                        >
                                            Email :{user.email.length <= 17 ? user.email : user.email.substring(0, 17) + "..."}
                                        </Typography>
                                    </Tooltip>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={8}>
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} sm={6}>
                                            <Paper elevation={1} className={styles.card} sx={{ padding: 2, height: '115px', textAlign: 'left' }} >
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Paper elevation={1} className={styles.card} sx={{ padding: 2, height: '115px' }} >
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            >
                                                ...
                                                <Typography variant="h4" color="#0161F7" fontWeight={700}>
                                                    {adminProfileData.totalCategory}
                                                </Typography>
                                            </Paper>
                                        </Grid>
                                        <Grid item xs={12} sm={6} >
